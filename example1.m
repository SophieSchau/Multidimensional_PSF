%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   Example for how to use the m_PSF    %
%                                       %
...
%   encodings with 100 spokes each.
%
...
%   We will use a 4x4 hadamerd encoding scheme
...
%   approximately uniform sampling R = 64*pi*0.5/10 = approx. 10.

pause(1)
figure(2)
m_psf(k1, H, [64 64], [1 1 1 1]);
title('m-PSF for same spokes every encoding')

pause(1)
figure(3)
m_psf(k2, H, [64 64], [1 1 1 1]);
